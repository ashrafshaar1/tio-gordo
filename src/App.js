...
const menuData = {
  shawarma: [
    ...
    { id: 11, name: 'Chicken Shawarma 250g', nameAr: 'شاورما دجاج 250غ', price: '$11.24', image: 'https://via.placeholder.com/80x80/E53935/ffffff?text=Platter', description: 'Served with French Fries, pickles, Tomato, Garlic.', descriptionAr: 'يقدّم مع البطاطا المقلية، المخلل، الطماطم، الثوم.' },
    { id: 12, name: 'Beef Shawarma 250g', nameAr: 'شاورما لحمة 250غ', price: '$20.22', image: 'https://via.placeholder.com/80x80/E53935/ffffff?text=Platter', description: 'Served with Tarator Sauce, Tomato, Debs reman, Onions, Parsley.', descriptionAr: 'يقدّم مع الطرطور، الطماطم، دبس الرمان، البصل والبقدونس.' },
    { id: 13, name: 'Sejok Shawarma 250g', nameAr: 'شاورما سجق 250غ', price: '$11.24', image: 'https://via.placeholder.com/80x80/E53935/ffffff?text=Platter', description: 'Served with French Fries, pickles, Tomato, Garlic.', descriptionAr: 'يقدّم مع البطاطا المقلية، المخلل، الطماطم، الثوم.' },
    ...
    { id: 15, name: 'Beef Shawarma 500g', nameAr: 'شاورما لحمة 500غ', price: '$31.46', image: 'https://via.placeholder.com/80x80/E53935/ffffff?text=Platter', description: 'Served with Tarator Sauce, Tomato, Debs reman, Onions, Parsley.', descriptionAr: 'يقدّم مع الطرطور، الطماطم، دبس الرمان، البصل والبقدونس.' },
    { id: 16, name: 'Sejok Shawarma 500g', nameAr: 'شاورما سجق 500غ', price: '$19.66', image: 'https://via.placeholder.com/80x80/E53935/ffffff?text=Platter', description: 'Served with French Fries, pickles, Tomato, Garlic.', descriptionAr: 'يقدّم مع البطاطا المقلية، المخلل، الطماطم، الثوم.' },
    { id: 17, name: 'Chicken Shawarma 1kg', nameAr: 'شاورما دجاج 1كغ', price: '$33.71', image: 'https://via.placeholder.com/80x80/E53935/ffffff?text=Platter', description: 'Served with French Fries, pickles, Tomato, Garlic.', descriptionAr: 'يقدّم مع البطاطا المقلية، المخلل، الطماطم، الثوم.' },
    { id: 18, name: 'Beef Shawarma 1kg', nameAr: 'طبق شاورما لحمة 1كغ', price: '$50.56', image: 'https://via.placeholder.com/80x80/E53935/ffffff?text=Platter', description: 'Served with Tarator Sauce, Tomato, Debs reman, Onions, Parsley.', descriptionAr: 'يقدّم مع الطرطور، الطماطم، دبس الرمان، البصل والبقدونس.' },
    { id: 19, name: 'Sejok Shawarma 1kg', nameAr: 'شاورما سجق 1كغ', price: '$39.32', image: 'https://via.placeholder.com/80x80/E53935/ffffff?text=Platter', description: 'Served with French Fries, pickles, Tomato, Garlic.', descriptionAr: 'يقدّم مع البطاطا المقلية، المخلل، الطماطم، الثوم.' },
  ],
  snacks: [
