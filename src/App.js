...
const menuData = {
  ...
  snacks: [
    { id: 11, name: 'Chicken Barbeque', nameAr: 'دجاج باربكيو', price: '$6.75', image: 'https://via.placeholder.com/80x80/6B8E23/ffffff?text=Falafel', description: 'Chicken Barbeque, Mayo, Rocca, Fresh Mushrooms, Mozzarella Cheese.', descriptionAr: 'دجاج باربكيو، مايونيز، روكا، فطر طازج، جبنة موزاريلا.' },
    { id: 12, name: 'Spicy Chicken', nameAr: 'دجاج حار', price: '$6.75', image: 'https://via.placeholder.com/80x80/6B8E23/ffffff?text=Falafel', description: 'Spicy Chicken, Mayo, Lettuce, Rocca, Fresh Mushrooms, Mozzarella Cheese.', descriptionAr: 'دجاج حار، مايونيز، خس، روكا، فطر طازج، جبنة موزاريلا.' },
    { id: 13, name: 'Chicken Sub', nameAr: 'دجاج', price: '$6.75', image: 'https://via.placeholder.com/80x80/6B8E23/ffffff?text=Falafel', description: 'Chicken, Garlic sauce, coleslaw, cocktail sauce, BBQ sauce, French fries, cheddar.', descriptionAr: 'دجاج، ثوم، سلطة كول سلو، صلصة كوكتيل، باربكيو، بطاطا مقلية، جبنة الشيدر.' },
    { id: 14, name: 'Mixed Mexican Chicken Sub', nameAr: 'دجاج مكسيكي مشكل', price: '$6.75', image: 'https://via.placeholder.com/80x80/6B8E23/ffffff?text=Falafel', description: 'Chicken, Green pepper, onions, carrot, lettuce, mayo sauce, mozzarella cheese, soy sauce.', descriptionAr: 'دجاج، فلفل أخضر، بصل، جزر، خس، مايونيز، جبنة موزاريلا، صلصة صويا.' },
    { id: 15, name: 'Crispy', nameAr: 'كرسبي', price: '$6.75', image: 'https://via.placeholder.com/80x80/6B8E23/ffffff?text=Falafel', description: 'Crispy Chicken, Garlic sauce, coleslaw, cocktail sauce, BBQ sauce, French fries, cheddar.', descriptionAr: 'دجاج كرسبي، ثوم، سلطة كول سلو، كوكتيل، باربكيو، بطاطا مقلية، جبنة شيدر.' },
    { id: 16, name: 'Fajita', nameAr: 'فاهيتا', price: '$6.75', image: 'https://via.placeholder.com/80x80/6B8E23/ffffff?text=Falafel', description: 'Chicken, Green pepper, onions, corn, mozzarella cheese, avocado sauce, soy sauce.', descriptionAr: 'دجاج، فلفل أخضر، بصل، ذرة، جبنة موزاريلا، صلصة أفوكادو، صلصة صويا.' },
    { id: 17, name: 'Zinger (Chicken)', nameAr: 'زنجر (دجاج)', price: '$6.75', image: 'https://via.placeholder.com/80x80/6B8E23/ffffff?text=Falafel', description: 'Chicken, Mayo sauce, lettuce, tomatoes, cheddar cheese, jalapeño.', descriptionAr: 'دجاج، صلصة مايونيز، خس، طماطم، جبنة شيدر، هالبينو.' },
    { id: 18, name: 'Escalope', nameAr: 'إسكالوب', price: '$6.75', image: 'https://via.placeholder.com/80x80/6B8E23/ffffff?text=Falafel', description: 'Chicken, Mayo sauce, lettuce, tomatoes, ketchup, Mozzarella Cheese.', descriptionAr: 'دجاج، صلصة مايونيز، خس، طماطم، كاتشب، جبنة موزاريلا.' },
    { id: 19, name: 'Francisco', nameAr: 'فرانسيسكو', price: '$6.75', image: 'https://via.placeholder.com/80x80/6B8E23/ffffff?text=Falafel', description: 'Chicken, Mayo, Pickles, Lettuce, Corn, Soya Sauce, Mozzarella Cheese.', descriptionAr: 'دجاج، مايونيز، كبيس، خس، ذرة، صلصة صويا، جبنة موزاريلا.' },
    ...
    { id: 25, name: 'Makanek', nameAr: 'مقانق', price: '$5.05', image: 'https://via.placeholder.com/80x80/6B8E23/ffffff?text=Falafel', description: 'Makanek, Mayo, Pickles, Tomato, Debs Reman.', descriptionAr: 'مقانق، مايونيز، كبيس، طماطم، دبس الرمان.' },
  ...
  burgers: [
    { id: 29, name: 'Lebanese Burger', nameAr: 'برغر لبناني', price: '$5.05', image: 'https://via.placeholder.com/80x80/E53935/ffffff?text=Burger', description: 'Beef patty, garlic sauce, pickles, tomatoes, fries, served with coleslaw.', descriptionAr: 'شريحة لحم بقري، ثوم، كبيس، طماطم، بطاطس مقلية، يقدم مع سلطة الكول سلو.' },
    { id: 30, name: 'Cheese Burger', nameAr: 'برغر بالجبنة', price: '$5.62', image: 'https://via.placeholder.com/80x80/E53935/ffffff?text=Burger', description: 'Beef patty, cheddar cheese, lettuce, tomatoes, pickles, mayo sauce.', descriptionAr: 'شريحة لحم بقري، جبنة شيدر، خس، طماطم، كبيس، صلصة مايونيز.' },
  ...
  platters: [
    ...
    { id: 34, name: 'Beef Shawarma Platter', nameAr: 'طبق شاورما لحمة', price: '$7.86', image: 'https://via.placeholder.com/80x80/E53935/ffffff?text=Platter', description: 'Served with Tarator Sauce, Tomato, Debs reman, Onions, Parsley.', descriptionAr: 'يقدّم مع الطرطور، الطماطم، دبس الرمان، البصل والبقدونس.' },
    { id: 35, name: 'Sejok Shawarma Platter', nameAr: 'طبق شاورما سجق', price: '$7.30', image: 'https://via.placeholder.com/80x80/E53935/ffffff?text=Platter', description: 'Served with French Fries, pickles, Tomato, Garlic.', descriptionAr: 'يقدّم مع البطاطا المقلية، المخلل، الطماطم، الثوم.' },
    { id: 36, name: 'Crispy Platter Large', nameAr: 'طبق كرسبي كبير', price: '$11.24', image: 'https://via.placeholder.com/80x80/E53935/ffffff?text=Grill', description: '6 Crispy Pcs Served with coleslaw, French Fries, garlic sauce, BBQ sauce, cheddar.', descriptionAr: '6 قطع كرسبي تقدّم مع سلطة الكول سلو، البطاطا المقلية، ثوم، الباربكيو، جبن الشيدر.' },
    { id: 37, name: 'Crispy Platter Small', nameAr: 'طبق كرسبي صغير', price: '$8.43', image: 'https://via.placeholder.com/80x80/E53935/ffffff?text=Grill', description: '4 Crispy Pcs Served with coleslaw, French Fries, garlic sauce, BBQ sauce, cheddar.', descriptionAr: '4 قطع كرسبي تقدّم مع سلطة الكول سلو، البطاطا المقلية، ثوم، الباربكيو، جبن الشيدر.' },
